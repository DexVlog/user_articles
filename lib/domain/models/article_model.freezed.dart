...
abstract class $ArticleModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'author_id') int authorId, int id, String content});
}
...
// ignore: invalid_annotation_target
  ...
  @override
  String toString() {
    return 'ArticleModel(authorId: $authorId, id: $id, content: $content)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, authorId, id, content);
...
abstract class _ArticleModel implements ArticleModel {
  factory _ArticleModel(@JsonKey(name: 'author_id') final int authorId,
      final int id, final String content) = _$_ArticleModel;
